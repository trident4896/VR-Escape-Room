...
public class RaycastSelection : MonoBehaviour
{
    ...
    public GameObject moreLastPreviousObject;
    public GameObject veryLastPreviousObject;
    public GameObject absoluteLastPreviousObject;
    public GameObject extremePreviousObject;
    public GameObject superPreviousObject;
