...
public class PickAndDrop : MonoBehaviour
{
    ...
    public void LiftObject()
    {
        ...
        if (saveTheItem.tag == "Puzzle")
        {
            ...
            saveTheItem.position = Vector3.Lerp(saveTheItem.position, hand.position, Mathf.SmoothStep(0.0f, 1.0f, fracDistance1));
        }
        ...
        if(saveTheItem.tag == "Clue" || saveTheItem.tag == "Selectable")
        {
            ...
            saveTheItem.position = Vector3.Lerp(saveTheItem.position, face.position, Mathf.SmoothStep(0.0f, 1.0f, fracDistance2));
        }
    ...
    public void DropObject()
    {
        if (saveTheItem != null)
        {
            ...
            saveTheItem.position = Vector3.Lerp(saveTheItem.position, saveTheNode.position, Mathf.SmoothStep(0.0f, 1.0f, fracDistance3));   
        }
